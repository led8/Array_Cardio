const inventors = [
    ...
    const totalYearsWithReduce = inventors.reduce(function(total, inventor){
      return total + (inventor.passed - inventor.year);
    },0);
    console.log(totalYearsWithReduce);
    ...
    // const de = links.forEach(function(element){
    //   array.push(element.textContent);
    //   array.filter(function(streetName){
